...
Defines the Storage port: a whole-collection in-memory model (loadAll/persistAll/delete) with an in-memory mock implementation, injected by the host at bootstrap. Filtering and statistics happen in plugin memory by design.
