# monorepo-infra Specification

## Purpose

Defines the repository infrastructure: pnpm workspace layout, turbo task orchestration with caching, the CI pipeline, and the platform-dependency guard that keeps @auktake/core pure.
