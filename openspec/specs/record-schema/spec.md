...
Defines the core data entities: MovieRecord (one record per viewing, movie or episode), Tag, MoodEntry (independent mood-history entity), and SyncMeta (stored separately from business data). All entities carry schemaVersion for future migrations.
