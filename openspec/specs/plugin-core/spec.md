...
Defines the AukTake plugin core: lifecycle contract (two-phase connect/create), tiered shutdown policy, permission declaration and validation, and the three communication channels (EventBus, CapabilityRegistry, ServiceRegistry). The core package is pure TypeScript with zero platform dependencies.
